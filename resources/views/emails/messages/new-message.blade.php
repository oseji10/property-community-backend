<!-- resources/views/emails/messages/new-message.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You have received a new message from <strong>{{ $sender->firstName ?? 'User' }} {{ $sender->lastName ?? '' }}</strong> regarding your property listing.</p>
            ...
            @if(isset($message->property) && $message->property)
